...
3600 s budget / half-resolution derived mesh; full: 7 periods / 21600 s /
full mesh), the PolarPoint.fidelity echo ("rans" | "urans_precalc" |
...
def test_fidelity_tier_contract_pin():
    ...
    assert URANS_FIDELITY_BUDGET_S == {UransFidelity.precalc: 3600, UransFidelity.full: 21600}
    ...
    assert urans_budget_seconds(SolverParams(urans_fidelity="precalc")) == 3600
    assert urans_budget_seconds(SolverParams()) == 21600
