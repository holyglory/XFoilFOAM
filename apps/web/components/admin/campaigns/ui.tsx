...
export function requiredChoiceIssue(
  value: string | null | undefined,
  field: string,
): ValidationIssue | null {
...
export function positiveIntegerIssue(
  value: number | null | undefined,
  field: string,
): ValidationIssue | null {
...
export const validationText: CSSProperties = {
  marginTop: 4,
  fontFamily: MONO,
  fontSize: 10,
  color: C.red,
    ...
    tone === "amber"
      ...
      : tone === "red"
        ...
        : tone === "teal"
          ...
          : C.dim;
  return (
    <div style={{ fontFamily: MONO, fontSize: 11, color, lineHeight: 1.4 }}>
      {text}
    </div>
  );
}
  ...
  return (
    ...
    >
      <button
        ...
        style={{ ...ghostBtn, padding: "5px 9px", fontSize: 10, color: C.teal }}
      >
        {buttonLabel}
      </button>
      {open && (
        ...
        >
          ...
          <span style={{ fontFamily: MONO, fontSize: 9, color: C.dimmest }}>
            picking adds a value — nothing is removed
          </span>
        </div>
      )}
    </span>
      ...
      >
        ...
        >
          ...
          <button
            ...
            onClick={onClose}
            style={{ ...ghostBtn, padding: "4px 9px" }}
          >
            ×
          </button>
        </div>
