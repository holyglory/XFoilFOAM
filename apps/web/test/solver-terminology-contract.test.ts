...
describe("solver terminology contract", () => {
  ...
  it("MUST-CATCH: Health and campaign detail do not expose an internal recovery state machine", () => {
    ...
    expect(health).not.toContain("Solver recovery");
    expect(campaign).not.toContain("Solver recovery");
